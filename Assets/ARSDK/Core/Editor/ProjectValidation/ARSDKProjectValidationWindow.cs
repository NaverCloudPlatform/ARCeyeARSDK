...
{
    /// <summary>
    /// ARSDK Project Validation Window
    /// Similar to XR Plugin Management's Project Validation
    /// </summary>
    public class ARSDKProjectValidationWindow : EditorWindow
    {
        private Vector2 scrollPosition;
        private List<ARSDKValidationRule> validationRules;
        private Dictionary<ARSDKValidationRule, bool> ruleResults;
        private bool showAll = true;
        private bool stylesInitialized = false;

        [MenuItem("ARC eye/ARSDK/Project Validation")]
        public static void ShowWindow()
        {
            var window = GetWindow<ARSDKProjectValidationWindow>("ARSDK Project Validation");
        ...
        {
            ARSDKProjectValidation.RefreshRules();
            validationRules = ARSDKProjectValidation.GetRules();
            ruleResults = new Dictionary<ARSDKValidationRule, bool>();
        ...
        private void DrawValidationRule(ARSDKValidationRule rule, bool passed)
        {
