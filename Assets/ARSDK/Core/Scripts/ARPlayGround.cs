...
namespace ARCeye
{
    ...
    {
        const string PLUGIN_VERSION = "1.6.0";
        ...
        public string amprojFilePath
        {
            get
            {
                ...
                string dataRootPath = m_StreamingAssets ? Application.streamingAssetsPath : Application.persistentDataPath;
                return $"{dataRootPath}/{ContentsPath}/{locationName}.amproj";
            }
        }

        [SerializeField]
        private bool m_StreamingAssets = true;
        public  bool StreamingAssets {
            get => m_StreamingAssets;
            set => m_StreamingAssets = value;
        }
        ...
        /// </summary>
        public void ShowARItems(float delay = 0.5f)
        {
